        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Experience unparalleled service in luxury real estate. From exclusive estates to prime investment opportunities, I deliver exceptional results for discerning clients.
            </p>
