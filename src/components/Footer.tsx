// Footer Component
// Generated: 2025-08-25T10:14:43.933Z
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Property Buying", href: "#buying" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Manhattan Beach", href: "/manhattan-beach" }
      ]
    },
    {
      title: "Resources",
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive exclusive market insights and luxury property listings. Unsubscribe anytime.
              </p>
            </div>
          </div>
      ...
      <div className="border-t border-border/50 bg-muted/20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="hidden sm:inline flex items-center gap-1">
                Serving with <Heart className="size-3 text-red-500 fill-current" /> and excellence
              </span>
            </div>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-6 mt-4 pt-4 border-t border-border/30">
            ...
            <Link href="/equal-housing" className="text-xs text-muted-foreground hover:text-foreground transition-colors">
              Equal Housing
            </Link>
          </div>
        </div>
