          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of satisfied clients who have trusted Amanda Foster with their luxury real estate needs. 
                Experience unparalleled service and expertise in Beverly Hills' most exclusive properties.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Personalized attention from initial contact to closing
              </p>
            </div>
          </div>
        </div>
